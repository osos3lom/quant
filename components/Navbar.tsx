...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-white/80 backdrop-blur-md dark:border-brand-800/60 dark:bg-brand-950/85">
      <nav className="mx-auto flex h-16 max-w-6xl items-center gap-3 px-4 sm:px-6">
        <Link href="/" className="flex items-center gap-2.5 shrink-0">
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-brand-600 to-brand-400 text-white shadow-sm dark:from-brand-500 dark:to-gold-400">
        ...
        <div className="ms-auto flex items-center gap-2">
          {mounted && progress.xp > 0 && (
            <span className="hidden items-center gap-1.5 rounded-lg bg-amber-50 px-2.5 py-1.5 text-xs font-semibold text-amber-700 sm:flex dark:bg-gold-400/12 dark:text-gold-300">
