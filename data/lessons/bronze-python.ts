...
export const bronzePythonNotebooks: Notebook[] = [
  ...
  /* ================================================================ */
  {
    ...
    summary:
      "بنية الدفتر التفاعلي: خلايا الكود وخلايا النصوص المنسّقة، طرق التنفيذ، كتابة المعادلات بـ LaTeX، والأوامر السحرية.",
    order: 1,
    estimatedMinutes: 18,
    objectives: [
      "التمييز بين خلايا الكود وخلايا النصوص المنسّقة",
...
- **خلايا الكود (Code)**: لكتابة كود Python وتنفيذها.
...
هذه أوامر مضمّنة في IPython تُنفَّذ داخل خلايا الكود:
